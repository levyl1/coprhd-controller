...
License: FIXME
Group: System
Requires: java-1.7.0, telnet, openssh
...
/etc/genconfig.d/boot/10controller
/etc/genconfig.d/boot/10coordinator
/etc/genconfig.d/boot/10db
/etc/genconfig.d/boot/10dbclient
